...
```{r load_workflow}
model_fits = read_model_fit(filename = "Dermochelys_coriacea-v1-model_fits")
model_fits
```
...
plot_prediction(rcp85_2075['default_rf']) + 
  ggplot2::ggtitle("Prediction for RCP8.5 in 2075") +
  ggplot2::facet_wrap(~month)

p2 <- plot_prediction(rcp85_2055['default_rf']) + 
  ggplot2::ggtitle("Prediction for RCP8.5 in 2055") +
  ggplot2::facet_wrap(~month, nrow = 1)
ggsave("rcp85_2055_monthly.png", plot = p2, width = 24, height = 5, units = "in")

plot_prediction(rcp45_2075['default_rf']) + 
  ggplot2::ggtitle("Prediction for RCP4.5 in 2075") +
  ggplot2::facet_wrap(~month)

p4 <- plot_prediction(rcp45_2055['default_rf']) + 
  ggplot2::ggtitle("Prediction for RCP4.5 in 2055") +
  ggplot2::facet_wrap(~month, nrow = 1)
ggsave("rcp45_2055_monthly.png", plot = p4, width = 24, height = 5, units = "in")
```
...
path = make_path("ColbyForecasting/predictions")
