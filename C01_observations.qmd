...
Eeek!  It's a carcass that washed up on shore!  We checked a number of others, and they are all carcasses.  Is that a presence?  Is that what we model are modeling?  If not then we should filter those out.
